...
\caption{Comparison of SFD temperature, two-component model $T_2$, and 
\cite{planckdust} temperature. Note the differing colorscales. Both models 
incorporating \PLANCK~data clearly show a major improvement in resolution 
relative to SFD.}
\end{center}
\end{figure}
...
use of SFD \verb|i100| instead of IRIS 100$\mu$m \citep{IRIS}. 
