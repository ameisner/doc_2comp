...
spatial pixel independently of those in neighboring pixels.
...
broad \verb|i100|/\PLANCK~bandpasses, each with $\Delta\nu/\nu\sim0.3$. We 
have therefore computed dimensionless finite bandpass correction factors to 
