...
\caption{Gridded osterior PDFs for three nside=2048 pixels. Red crosses mark 
...
no multimodality, and our MCMC parameter estimates coincide well with the
peaks in the gridded posteriors. The colorscale is linear in log(P), with black representing the maximum of log(P) and white represent max(log(P))-5. Left: Low S/N pixel at high-latitude in 
Galactic north. Center: High S/N pixel in the Polaris region. Right: Low S/N pixel at high-latitude in the Galactic 
south. }
\end{center}
\end{figure*}
