...
\begin{figure*}
\begin{center}
\epsfig{file=compare_lofreq.eps, width=6.6in}
...
All of the best-fit offsets, in both the single-MBB and two-component cases,
are within the uncertainties quoted in Table \ref{table:offs}. On the other 
hand, Figure \ref{fig:lofreq} shows that the \cite{planckdust} single-MBB 
predictions yield slopes substantially different from unity: 1.079 at 217 GHz, 
1.126 at 143 GHz, and 1.188 at 100 GHz. The fact that the slopes are larger 
than unity indicates that the \cite{planckdust} predictions are systematically 
low. The systematic underprediction evidently become gradually more severe as 
lower frequencies are considered, with a 7.9\% underprediction at 217 GHz, a 
12.6\% underprediction at 143 GHz and an 18.8\% underprediction at 100 GHz.
...
On the other hand, the 143 and 100 GHz predictions are truly based on 
extrapolation.
