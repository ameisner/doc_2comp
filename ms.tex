...
%end section saying that the predictions accessible through our data 
% release should be investigated/tested/swapped in by people doing
% B-mode stuff

%striping in IRAS/IRIS versus in SFD IRAS ... planck dust map obvious striping
%%%An important difference between our maps and those of \cite{planckdust} is 
%%%our 
...
The prominence of the ecliptic plane in our 
full-sky temperature map of Figure \ref{fig:results} suggests that zodiacal
light subtractions performed on the input maps are not ideal. Our comparisons 
of the maps used in this study against HI emission bear out this notion, and 
show that the imperfect zodi corrections are not limited to \verb|i100| (the
highest frequency for which the zodi should be most problematic), but in fact
are noticeable in all of the HFI ZodiCorrected maps as well. We deemed it 
infeasible to reconsider all of the \PLANCK~zodi corrections in addition to the
3000 GHz zodi correction as a part of this study. Perhaps the forthcoming 
\PLANCK~data release, including data from additional orbits, will effectively 
eliminate any residual zodi problems in the \PLANCK~bands. Under these 
circumstances it might then be worthwhile to consider revising the DIRBE 
...
the impact of dust map choice in a specific application.
