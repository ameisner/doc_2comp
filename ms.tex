...
The ony solution we were able to identify that both removed the `bend' vs.
$E(B-V)_{SFD}$ and the temperature dependence of the residual was cutting 
...
obvious systematic problem with the temperature correction upon inspecting the 
full-sky temperature map in Figure \ref{fig:results}.
