...
For each pixel, we initialize the Markov chain with parameters $T_2$ = 
$\bar{T}_2$ and $\tilde{I}_{545}$ = $I_{545}$. We run 500 steps of burn-in and 
then 2000 steps during which we keep track of the proposed $T_{2, j}$ and 
