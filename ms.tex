...
a dependence of the reddening residuals on dust temperature.

%Clearly there are some systematic trends in the residuals.
%Still, for $E(B-V)_{SFD}$$<$0.28 ($\sim$80\% of the sky), the residual median 
%is always within 10 mmag of zero. Over the entire range $E(B-V)_{SFD}$$<$0.7, 
%the residual median is always within 30 mmag of zero.
