...
\PLANCK~143-545 GHz after correcting for the best-fit offset and residual Solar
dipole. Bottom right: \PLANCK~100 GHz after applying the spherical harmonic 
corrections of Equation \ref{equ:harm}. The dashed red line shows the best-fit 
linear relationship in all cases.}
\end{center}
\end{figure}
...
shows posterior PDFs for three pixels.
...
two-component $\tau_{545}$, restricting to $|b|$$>$20$^{\circ}$.}
\end{center}
\end{figure}
