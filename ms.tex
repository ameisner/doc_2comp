...
by smoothing the input maps $1^{\circ}$ FWHM, and pixelize at $N_{side}=64$. To
best constrain the model parameters in each pixel, we also include \PLANCK~100 
GHz and 143 GHz, and DIRBE 140$\mu$m and 240$\mu$m, all at $1^{\circ}$ 
resolution.
