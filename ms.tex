...
Inspecting the HFI maps at 100-545 GHz, the need for low-order corrections beyond
a scalar offset were evident. In particular, we noticed the presence of a residual 
Solar dipole. To best recover the amplitudes of the low-order corrections, it is
necessary to have the highest-possible signal in the independent variable of our
regression. For this reason we have used 857 GHz as a reference for the other HFI 
bands, as opposed to the FDS99 predictions or H\,\textsc{i}. 

Importantly, we have performed one regression per HFI band to simultaneously fit for the 
zero level offset, the slope relative to 857 GHz, and the residual dipole amplitude.
For each 100-545 GHz HFI band, we restrict tor regions of low column density
(H\,\textsc{i} $<$ 200 K\,km\,s$^{-1}$ for $-72$$<$$v_{LSR}$$<$$+25$ km\,s$^{-1}$)
