...
\startdata
100 & 1.69$\times$10$^{-5}$$\pm$3.61$\times$10$^{-7}$ &  &  &  & 9.66 \\
143 & 3.58$\times$10$^{-5}$$\pm$7.58$\times$10$^{-7}$ &  & - &  &  7.27 \\
217 & 7.79$\times$10$^{-5}$$\pm$2.60$\times$10$^{-6}$ &  & - &  &  5.01 \\
353 & $\pm$ &  & - &  &  \\
    & Offset ($K_{CMB}$) & Dipole ($K_{CMB}$) & Quadrupole ($K_{CMB}$) & & \\ \cline{2-4} \\ [-2ex]
545 & $\pm$ &  & - &  &  \\
857 & $\pm$ &  & - &  &  \\
3000 & 0.0$\pm$4.3$\times$10$^{-2}$ & & & & 6.1
\enddata
\end{deluxetable*}
