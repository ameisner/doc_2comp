...
% one or two last sentence(s) saying two-component model still alive, wasn't
% an artifact of FIRAS, and also the predictions from our data release
% are a suitable alternative for estimating CMB foregrounds and can provide
% a handle on foreground systematics when swapped for other 
