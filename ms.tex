...
both DIRBE/\IRAS~and \PLANCK~to be the dominant large-scale systematic problem 
in our two-component temperature map and reddening estimates.
...
restricting to high ecliptic latitude, $|\beta|>20^{\circ}$. In both the top 
left and top right plots, the bending of the reddening residuals as a function 
of $E(B-V)_{SFD}$ seen in Figure \ref{fig:resid} has been eliminated. Further, 
the two-component reddening residual temperature dependence (bottom left) has 
been significantly reduced relative to the corresponding trend shown in Figure 
\ref{fig:resid}.}
\end{center}
\end{figure*}
...
summarizing the results of our full-resolution two-component dust fits. 
Refer to the data release documentation and FITS file headers for further 
details.

% will we release software for making thermal dust predictions (i suppose
% we can just release a reddening map, and there doesn't need to be 
% any software released in that regard?)
