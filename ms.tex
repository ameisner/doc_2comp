...
\tablehead{
\colhead{$\nu$ (GHz)} &
\colhead{Offset (MJy/sr)} & 
\colhead{Dipole (MJy/sr)} & 
\colhead{Quadrupole (MJy/sr)} & 
\colhead{$c_{\nu}$} &
\colhead{FWHM ($'$)}
}
\startdata
100 & 1.69$\times$10$^{-5}$$\pm$3.61$\times$10$^{-7}$ &  &  &  0.0054 & 9.66 \\
143 & 3.58$\times$10$^{-5}$$\pm$7.58$\times$10$^{-7}$ &  & - & 0.0054 &  7.27 \\
217 & 7.79$\times$10$^{-5}$$\pm$2.60$\times$10$^{-6}$ &  & - & 0.0054 &  5.01 \\
353 & 2.76$\times$10$^{-4}$$\pm$1.95$\times$10$^{-5}$ &  & - & 0.012 & 4.86 \\
    & Offset ($K_{CMB}$) & Dipole ($K_{CMB}$) & Quadrupole ($K_{CMB}$) & & \\ \cline{2-4} \\ [-2ex]
545 & 7.28$\times$10$^{-2}$$\pm$1.99$\times$10$^{-2}$ &  - & - & 0.10 & 4.84 \\
