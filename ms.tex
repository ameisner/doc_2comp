...
optical wavelengths. In $\S$\ref{sec:results} we present the full-sky maps of 
...
have used \PLANCK~857 GHz as a reference for the 100-545 GHz bands, as opposed 
to the FDS99 predictions or H\,\textsc{i} data. In doing so, we assume
\PLANCK~857 GHz contains no appreciable Solar dipole residual or other 
low-order problems. % grammar?
