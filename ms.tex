...
and are illustrated by the dashed red lines in plots of Figure \ref{fig:dip}, 
right column. The 857 GHz slope is by definition unity.
...
this problem sufficiently constrained, and also in providing information near 
the peak of the dust SED at $\sim$140$\mu$m, which is particularly sensitive to
 the presence of a single versus multiple MBB components. % last sentence mentioning
...
%All comparisons between %\PLANCK~and the FDS99 predictions were made after 
%smoothing both to $1^{\circ}$, subtracting the SMICA CMB model, and ignoring 
%SMICA inpainted pixels. For 100-857 GHz, the linearity between the FDS and 
%\PLANCK~is excellent.
