...
necessary. Therefore, for 100 GHz, we performed a modified version of the 
Eqation \ref{equ:dip} fit, using the following model:

\begin{equation} \label{equ:quad}
\mathcal{I}_{100, p} = a\mathcal{I}_{857, p} + b\mathcal{D}_p + c + qQ_p
\end{equation}
