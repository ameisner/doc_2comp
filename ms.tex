...
The \PLANCK~217 GHz and 353 GHz data are provided in thermodynamic $\delta T$, 
while \verb|i100| and the higher frequency \PLANCK~maps are provided in units 
of MJy/sr. Although the aforementioned preprocessing steps were conducted with 
each map in its native units, we converted the 217 GHz and 353 GHz 
...
%mention that we're using healpix in Galactic coordinates !!!!!!
