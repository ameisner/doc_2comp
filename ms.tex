...
In order to fit the \PLANCK/\verb|i100| dust SED, we must combine the 
underlying two-component spectrum $M_{\nu}$ with the bandpass corrections 
$b_{\nu_i}$ to yield predictions which can be compared against the observed 
broadband intensities. The model-predicted broadband intensities 
$\tilde{I}_{\nu_i}$ are given by:
