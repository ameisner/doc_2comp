...
\caption{\label{fig:chi2_dirbe} Testing }
\end{center}
\end{figure}
...
First, we considered single-MBB models with $\beta$ spatially constant (see the
black line in Figure \ref{fig:chi2_dirbe}). $\beta$=1.57 yields the best fit, with 
