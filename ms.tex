...
% could use an opening sentence here just reiterating that a major thrust of
% this work was to decide whether the two-component model
% still makes sense after swapping in Planck for FIRAS

% second sentence of opening paragraph reiterating what the basic two
% strategies were that we employed to compare dust SED models
