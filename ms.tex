...
we convert all measurements to MJy/sr following the guidelines of \cite{planckresponse} and the document ``HFI-unit conversion and colour correction instructions v1.2''.
...
% with the ones i actually used from the other document
...
% what about the instrumental noise n_{\nu_i} ---> can't find anything
% in planck literature ... nevermind n^2 <-> ii_cov in binary tables
...
\subsubsection{Ignoring 217 GHz}
The \cite{planckdust} result used only XX, YY, ZZ, 3000 GHz. When we 
