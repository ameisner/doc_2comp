...
\verb|HFI_RIMO_R1.10.fits| \citep{planckresponse}. These bandpass correction 
factors are applied in the sense that $b_{\nu_i}(T ,\beta)\times M_{\nu_{i,c}}$
is a prediction suitable for comparison to the \PLANCK~data products.
