...
opportunity to revisit foreground predictions in light of their superb, 
...
data near the peak of the dust SED, for example \AKARI~140-160$\mu$m. We also 
anticipate the optical depth map we derive will be useful as a comparison for 
extinction estimates based directly upon optical/NIR observations of stars.
...
143 GHz) were not used in our fit, while the four lowest-frequency data
